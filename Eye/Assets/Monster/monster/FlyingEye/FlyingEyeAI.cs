...
public class FlyingEyeAI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Vector2 rot = new Vector2(transform.position.x - Management.CharPos.x, transform.position.y - Management.CharPos.y);
            ...
            if (Management.CharPos.x < transform.position.x)
            {
                renderer.flipX = true;
